...
class Settings(BaseSettings):
    ...
    LANGGRAPH_CHECKPOINT_URL: str | None = Field(default=None)
    ...
    INDEX_TASK_RETENTION_SECONDS: int = Field(default=86_400)
    INDEX_TASK_MAX_ENTRIES: int = Field(default=1000)
